...
$subject = 'Tu publicación ha sido restaurada';
$preheader = 'Tu publicación vuelve a estar disponible.';
$name = \App\Services\EmailRenderer::plain($displayName);
$title = \App\Services\EmailRenderer::plain($listingTitle);
$text = "Hola {$name},\n\nTu publicación ha sido restaurada: {$title}\nVer publicación:\n{$actionUrl}\n";
ob_start();
?>
<p style="margin:0 0 16px 0;">Hola <?= $e($displayName) ?>,</p>
<p style="margin:0 0 16px 0;">Tu publicación ha sido restaurada: <strong><?= $e($listingTitle) ?></strong></p>
